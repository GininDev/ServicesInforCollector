...
namespace GininDev.Common.DataTools.DynLoader.Plugin
{
    ...
    public static class SqlHelper
    {
        ...
        {
            FillDataset(connectionString, commandType, commandText, dataSet, tableNames, false);
        }
        ...
        public static void FillDataset(string connectionString, CommandType commandType, string commandText,
            DataSet dataSet, string[] tableNames, bool fillSchema)
        {
            if (string.IsNullOrEmpty(connectionString))
            {
                throw new ArgumentNullException("connectionString");
            ...
            using (var connection = new SqlConnection(connectionString))
            {
                ...
                // Call the overload that takes a connection in place of the connection string
                FillDataset(connection, commandType, commandText, dataSet, tableNames, fillSchema);
            }
        }
        ...
        public static void FillDataset(SqlConnection connection, CommandType commandType, string commandText,
            DataSet dataSet, string[] tableNames)
        {
            FillDataset(connection, commandType, commandText, dataSet, tableNames, false);
        }
        ...
        public static void FillDataset(SqlConnection connection, CommandType commandType, string commandText,
            DataSet dataSet, string[] tableNames, bool fillSchema)
        {
            FillDataset(connection, commandType, commandText, dataSet, tableNames, fillSchema, null);
        }
        ...
        public static void FillDataset(SqlConnection connection, CommandType commandType,
            ...
            params SqlParameter[] commandParameters)
        {
            FillDataset(connection, commandType, commandText, dataSet, tableNames, false, commandParameters);
        }
        ...
        public static void FillDataset(SqlConnection connection, CommandType commandType,
            string commandText, DataSet dataSet, string[] tableNames, bool fillSchema,
            params SqlParameter[] commandParameters)
        {
            FillDataset(connection, null, commandType, commandText, dataSet, tableNames, fillSchema, commandParameters);
        }
        ...
        {
            FillDataset(connection, transaction, commandType, commandText, dataSet, tableNames, false, commandParameters);
        }
            ...
            params SqlParameter[] commandParameters)
        {
            ...
            using (var dataAdapter = new SqlDataAdapter(command))
            {
                ...
                {
                    const string cTable = "Table";
                    string tableName = cTable;
                    for (int index = 0; index < tableNames.Length; index++)
                    {
                        ...
                        tableName = cTable + (index + 1);
                    }
                }

                if (fillSchema)
                {
                    // Fill Schema into the DataSet, chenfojin (R2), 2005.06.30
        ...
        private static SqlParameter[] AssignParameterValuesWithReturnValue(SqlConnection connection, string spName,
            object[] parameterValues, out SqlParameter returnParameter)
        {
            SqlParameter[] commandParameters;
            returnParameter = new SqlParameter("@RETURN_VALUE", SqlDbType.Int, 4)
            {Direction = ParameterDirection.ReturnValue};
            SqlParameter[] _commandParameters = SqlHelperParameterCache.GetSpParameterSet(connection, spName);
            if ((parameterValues == null) || (parameterValues.Length <= 0))
            {
                commandParameters = new[] {returnParameter};
            }
            else
            {
                if (_commandParameters == null) throw new ArgumentNullException("_commandParameters");
                AssignParameterValues(_commandParameters, parameterValues);
                commandParameters = new SqlParameter[_commandParameters.Length + 1];
                commandParameters[0] = returnParameter;
                _commandParameters.CopyTo(commandParameters, 1);
            }
        ...
        public static int ExecuteReturnValue(SqlConnection connection, string spName, params object[] parameterValues)
        {
            if (connection == null)
            {
                throw new ArgumentNullException("connection");
            ...
            SqlParameter[] commandParameters = AssignParameterValuesWithReturnValue(connection, spName, parameterValues,
                out returnParameter);
        ...
        /// <param name="parameterValues">参数值</param>
        /// <returns>存储过程返回值</returns>
        public static int ExecuteReturnValue(string connectionString, string spName, params object[] parameterValues)
        {
            using (var connection = new SqlConnection(connectionString))
            {
                return ExecuteReturnValue(connection, spName, parameterValues);
            }
        }
        ...
        /// <param name="parameterValues">参数值</param>
        /// <returns>存储过程返回值</returns>
        public static int ExecuteReturnValue(SqlTransaction transaction, string spName, params object[] parameterValues)
        {
            if (transaction == null)
            {
                throw new ArgumentNullException("transaction");
            ...
            SqlParameter returnParameter;
            SqlParameter[] commandParameters = AssignParameterValuesWithReturnValue(transaction.Connection, spName,
                parameterValues, out returnParameter);

            ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName, commandParameters);
            return (int) returnParameter.Value;
        }

        #endregion ExecuteReturnValue
